    ...
    <div className="resume-wrap">
        ...
        <div className="resume">
            <div className="right">
                <h1>Luke Whyte</h1>
                <h2>Summary</h2>
                <span>Over 8 years of experience as a developer, designer and journalist with a focus on data dashboards, analysis, visualization and investigative journalism. I love being challenged and learning new things.</span>
                <h2>Technical Skills</h2>
                <span>JavaScript, Python, SQL, Statistics, PHP, Excel, TypeScript, React.js, Angular.js, Vue.js, D3.js, Leaflet.js, MapBox, Node.js, Express, Django, Apache, NLP, Hadoop, Wordpress, MVC, CSS3, NoSQL, Single-page apps & Photoshop</span>
